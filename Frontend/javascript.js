...
const planetData = {
  ...
  html: `
    <p>Tata surya kita adalah sistem kosmik yang terikat gravitasi pada Matahari, bintang pusat yang mencakup hampir seluruh massa sistem ini dan menjadi sumber energi utama. Di orbit terdekat, terdapat empat planet terestrial berbatu: Merkurius yang kecil, Venus yang panas, Bumi yang penuh kehidupan, dan Mars yang berdebu. Wilayah ini dipisahkan oleh Sabuk Asteroid sebelum beralih ke domain raksasa gas, yaitu Jupiter yang masif dan Saturnus dengan cincin megahnya, serta raksasa es Uranus dan Neptunus yang berada di tepian dingin. Melampaui orbit planet terakhir, terdapat Sabuk Kuiper, sebuah wilayah berisi objek-objek es dan planet kerdil seperti Pluto yang menjadi sisa-sisa beku dari masa pembentukan awal. Namun, batas tata surya sebenarnya membentang jauh lebih luar hingga mencapai Awan Oort, sebuah cangkang raksasa berbentuk bola yang menyelimuti seluruh sistem kita. Awan Oort diperkirakan berisi triliunan benda es atau komet purba yang bergerak sangat lambat pada jarak hingga ribuan Satuan Astronomi. Wilayah misterius ini menandai batas akhir pengaruh gravitasi Matahari sebelum akhirnya menyatu dengan ruang antarbintang yang luas. Dari panasnya korona Matahari hingga dinginnya Awan Oort, tata surya menunjukkan skala ruang yang luar biasa, di mana planet-planet besar hanyalah titik kecil di dalam gelembung luas yang dilindungi oleh medan magnet dan gravitasi satu bintang tunggal kita. info dari nasa.gov dan esa.int.
</p>
  `,
},
